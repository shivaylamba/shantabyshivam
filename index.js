...
// app.post(
//   "/api/traineeCourseProgress",
//   traineeCourseProgressController.traineeCourseProgress
// );
// app.post(
//   "/api/traineeCourseCompleteDetails",
//   traineeCourseProgressController.traineeCourseCompleteDetails
// );
// app.post("/api/addEmployee", adminAdd_updateEmployeeController.addEmployee);
// app.put(
//   "/api/updateEmployee",
//   adminAdd_updateEmployeeController.updateEmployee
// );
...
// app.post(
//   "/api/admindeleteCourse",
//   adminAddDeleteCourseController.admin_deleteCourse
// );
...
// app.post(
//   "/controllers/traineeCourseCompleteDetails",
//   traineeCourseProgressController.traineeCourseCompleteDetails
// );
// app.post(
//   "/controllers/traineeCourseProgress",
//   traineeCourseProgressController.traineeCourseProgress
// );
// app.post("/controllers/addCourse", addCourseController.addCourse);
// app.post(
//   "/controllers/addEmployee",
//   adminAdd_updateEmployeeController.addEmployee
// );
// app.put(
...
// );
// app.post(
//   "/controllers/getIdEmployee",
//   adminDeleteEmployeeController.getDeleteEmployee
// );
// app.post(
//   "/controllers/deleteEmployee",
//   adminDeleteEmployeeController.deleteEmployee
// );
// app.post("/controllers/addTrainer", adminAddDeleteTrainerController.addTrainer);
// app.post(
//   "/controllers/deleteTrainer",
//   adminAddDeleteTrainerController.deleteTrainer
// );
// app.post(
//   "/controllers/adminaddCourse",
//   adminAddDeleteCourseController.admin_addCourse
// );
// app.post(
